...
export const PATH_CLASS_NAMES = Object.freeze(["test", "e2e", "generated", "vendored", "mock", "story", "docs", "benchmark", "temp"]);
export const PATH_CLASS_QUERY_TERMS = Object.freeze({
  ...
  vendored: Object.freeze(["vendor", "vendored", "third-party", "third_party"]),
...
const DEFAULT_RULES = [
  ...
  {
    category: "vendored",
    pattern: "vendored or third-party source root",
    regex: /(^|\/)(?:vendor|vendored|third[-_]?party)(\/|$)/i,
  },
  {
    category: "mock",
