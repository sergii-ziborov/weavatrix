...
- The public page keeps the same design while its CSS and canvas animation move into focused assets;
  reduced-motion mode stops animation. A release test enforces a physical 300-line ceiling for
